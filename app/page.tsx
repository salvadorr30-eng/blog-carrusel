...
export default function HomePage() {
  ...
  return (
    <div className="space-y-20">
      ...
      {/* ── NEWSLETTER ── */}
      <section className="rounded-3xl overflow-hidden bg-gradient-to-br from-violet to-sky p-10 md:p-16 text-center text-white">
        ...
        <p className="mt-3 text-white/80 max-w-md mx-auto">
          Novedades, extractos exclusivos y un capítulo gratis al suscribirte.
        </p>
        <form className="mt-8 flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          <input
            type="email"
            placeholder="tu@email.com"
            className="flex-1 px-5 py-3.5 rounded-full text-ink focus:outline-none focus:ring-2 focus:ring-white/50"
          />
          <button
            type="submit"
            className="bg-sunshine text-ink font-semibold px-7 py-3.5 rounded-full hover:bg-yellow-300 transition shadow-lg"
          >
            Suscribirme
          </button>
        </form>
