    ...
    <div className='max-w-3xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='space-y-10'>
        ...
        >
          ...
          <Field
            label='URL impreso (tienda propia)'
          ...
          <Field
            label='📦 URL libro impreso en Amazon KDP'
            hint='URL del producto en Amazon (paperback). Aparecerá con botón naranja en la ficha del libro.'
          >
            <input
              type='url'
